...
which extends the same anytime-valid guarantees to a Sequential Model
Confidence Set (SMCS):
...
[`vignette("smcs", package = "seqcomp")`](https://alasgarliakbar.github.io/seqcomp/articles/smcs.md).
