...
`(-Inf, 1]` (Proposition EC.4, Choe & Ramdas 2024). Used to apply
Theorems 2 & 3 to unbounded scoring rules on binary outcomes.
...
guaranteed, use the one-sided (upper) CS only, as in the CR24 MLB
experiments.
