...
- boundary:
  ...
  stitched) or "hardcoded" (CR24 example formula, only valid for
  alpha=0.05, c=1).
...
#> 1 1     0.05 -8.191929 8.291929
#> 2 2     0.06 -4.061458 4.181458
#> 3 3     0.05 -2.698378 2.798378
#> 4 4     0.06 -2.002269 2.122269
```
